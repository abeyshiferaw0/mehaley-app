...
class EtDatetime extends EDT {
  ...
  EtDatetime.fromMillisecondsSinceEpoch(int millisecondsSinceEpoch)
    ...
    if (fixed == null) throw ArgumentError();
    if (millisecondsSinceEpoch.abs() > maxMillisecondsSinceEpoch ||
        (millisecondsSinceEpoch.abs() == maxMillisecondsSinceEpoch)) {
      throw ArgumentError(
  ...
  ///
  String? get monthGeez => months[(month - 1) % 13];
  ...
  /// ```
  ///
  String get dayGeez => dayNumbers[(day - 1) % 30];
